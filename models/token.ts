...
import type { UserToken, TUserTokenWithUser } from '@/models/userToken'
...
export type TTokenWithUser = Omit<TokenDoc, '_user'> & {
  _user: TUserDoc
  totalBalance: string
}
export type TTokenWithUserToken = Omit<TokenDoc, '_userToken'> & {
  _userToken: TUserTokenWithUser
  totalBalance: string
}
